...
<html lang="pt-ao">
    <head>
        ...
        <title>Pagina de Controle - Reservas de reembolso</title>
        ...
        <div class="container-fluid" id="main-content">
            <div class="row">
                <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                    <div class="col-md-12 fs-4 breadcrumb"><a href="../Admin/Admin_view.php"><i class="bi bi-house" style="color: rebeccapurple;"></i></a> / Reservas / Reservas de reembolso</div>
                                ...
                                <table class="table table-hover border" style="min-width: 1200px;">
                                    <thead>
                                        <tr class="bg-dark text-light">
                                            ...
                                            <th scope="col">Quantia de reembolso</th>
